...
/*Older version not supported now*/
/*
...
const char cmd_0[] PROGMEM = "ATE0";
const char cmd_1[] PROGMEM = "AT+WWPA=";
const char cmd_2[] PROGMEM = "AT+WA=";
const char cmd_3[] PROGMEM = "AT+NDHCP=0";
const char cmd_4[] PROGMEM = "AT+NDHCP=1";
const char cmd_5[] PROGMEM = "AT+WD";
const char cmd_6[] PROGMEM = "AT+NSTCP=";
const char cmd_7[] PROGMEM = "AT+NCTCP=";
const char cmd_8[] PROGMEM = "AT+NMAC=?";
const char cmd_9[] PROGMEM = "AT+DNSLOOKUP=";
const char cmd_10[] PROGMEM = "AT+NCLOSE=";
const char cmd_11[] PROGMEM = "AT+NSET=";
const char cmd_12[] PROGMEM = "AT+WM=2";
const char cmd_13[] PROGMEM = "AT+DHCPSRVR=1";
const char cmd_14[] PROGMEM = "AT+NSUDP=";
const char cmd_15[] PROGMEM = "AT+NCUDP=";
const char cmd_16[] PROGMEM = "ATB=115200,8,n,1";

/*Older version not supported now*/
/*
PROGMEM const char *cmd_tbl[] =
*/
PGM_P const cmd_tbl[] PROGMEM =
{
...
{	
	if ((len == 0) || (buf[0] == '\r')){
	    ...
	    if ((this->sock_table[s].protocol == IPPROTO::TCP) ||
	        ...
	        Serial2.write((uint8_t)int_to_hex(this->sock_table[s].cid));  // connection ID
	        Serial2.print(srcIPUDP);
	        Serial2.print(":");
	        Serial2.print(srcPortUDP);
	        Serial2.print(":");
	        if (len == 1){
	            if (buf[0] != '\r' && buf[0] != '\n'){
	                Serial2.write(buf[0]);           // data to send
